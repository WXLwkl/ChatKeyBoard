...
@interface MessageBubbleHelper () {
    
    NSCache *_attributedStringCache;
}
@end

@implementation MessageBubbleHelper

+ (instancetype)sharedMessageBubbleHelper {
    static MessageBubbleHelper *sharedInstance = nil;
    
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        sharedInstance = [[MessageBubbleHelper alloc] init];
    });

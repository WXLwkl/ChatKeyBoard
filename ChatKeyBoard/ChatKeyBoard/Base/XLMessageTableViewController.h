//
//  XLMessageTableViewController.h
//  ChatKeyBoard
//
...
#pragma mark - MessageTableViewControllerDelegate
@protocol MessageTableViewControllerDelegate <NSObject>
 ...
 *  配置TableViewCell高度的方法，如果你想定制自己的Cell样式，那么你必须要实现DataSource中的方法
 - (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath targetMessage:(id<MessageModel>)message;
 *
 ...
 *  @return 返回计算好的Cell高度
 */
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath targetMessage:(id<MessageModel>)message;
@end

#pragma mark - MessageTableViewControllerDataSource
@protocol MessageTableViewControllerDataSource <NSObject>
...
#pragma mark - XLMessageTableViewController
@interface XLMessageTableViewController : UIViewController

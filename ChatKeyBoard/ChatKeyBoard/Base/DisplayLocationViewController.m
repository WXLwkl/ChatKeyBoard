...
@interface DisplayLocationViewController ()<MKMapViewDelegate>
...
- (void)loadLocations {
    ...
    Annotation *myRegionAnnotation = [[Annotation alloc] initWithCLRegion:newRegion title:NSLocalizedStringFromTable(@"MessageLocation", @"MessageDisplayKitString", nil) subtitle:self.message.geolocations];
